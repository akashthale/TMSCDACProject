                ...
                <div>
                    ...
                    <main>
                                ...
                                <div className="carousel-item active">
                                    ...
                                    <div className="container">
                                        <div className="carousel-caption">
                                            ...
                                            <p><a className="btn btn-lg btn-info" onClick={this.singnUpHandler} role="button"> Register Now &nbsp;<i className="fa fa-truck fa-flip-horizontal fa-lg" /> </a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {/* START THE FEATURETTES */}
                            <br style={{paddingTop:'100px'}} id="aboutus"/>
                        <div className="container marketing">
                            
                            
                            <div className="row featurette text-secondary" >
                            ...
                            <hr className="featurette-divider" id="services" style={{paddingTop:'50px'}}/>
                            <span  />
                            <div className="row featurette">
                                ...
                                <div className="col-md-5">
                                    <img className="img-thumbnail" src="https://images.unsplash.com/photo-1570449942860-bb66578faf58?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=500&ixid=MnwxfDB8MXxyYW5kb218MHx8bG9naXN0aWNzfHx8fHx8MTY5MzQ1NTkxOA&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=500" alt />
                    ...
                    <footer className="container-fluid text-center" id="contact">
                        <div className="row">
                            ...
                            <div className="col-sm-3">
                                <h3>Address</h3>
                                <h5><i className="fa fa-map-marker" aria-hidden="true" />&nbsp;MET BKC, Nashik, Maharashtra, Pin: 422003
                                </h5>
                            </div>
                            <div className="col-sm-3">
                                <h3>Reach To Us</h3>
                                <h5><i className="fa fa-envelope" aria-hidden="true" /> tms@gmail.com</h5>
                                <h5><i className="fa fa-phone-square" aria-hidden="true" /> +91 1234567890</h5>
                            </div>
                            
                        </div>
                    </footer>
                    <div className="copyright text-center text-secondary">
                        © Copyright <strong><span>TMS</span></strong>. All Rights Reserved
                    </div>
                </div>
